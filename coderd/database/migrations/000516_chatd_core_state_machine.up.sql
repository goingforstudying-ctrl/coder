...
-- 11. Default sequence for new queued-message positions.
...
-- 12. Backfill chats.queue_version = 1 for chats that already have queued
...
-- 13. chat_heartbeats: unlogged table for ownership leases. Keyed by
...
-- 15. Queue version trigger function.
...
-- 16. Retry state trigger function.
